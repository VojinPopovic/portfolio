...
function NavMobile(props) {
  const hamOpen = useRef();
  const hamClose = useRef();
  ...
  function hamburgerOpen() {
    hamOpen.current.style.display = "none";
    hamClose.current.style.display = "flex";
  }
  function hamburgerClose() {
    hamClose.current.style.display = "none";
    hamOpen.current.style.display = "flex";
  }

  return (
    <HamburgerDiv>
      <div className="hamburger-open hamburger" onClick={hamburgerOpen} ref={hamOpen}>
        {/* prettier-ignore */}
      ...
      <div className="hamburger-close hamburger" onClick={hamburgerClose} ref={hamClose}>
        {/* prettier-ignore */}
